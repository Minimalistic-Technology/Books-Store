        ...
        <div className="flex items-center">
          ...
          <div className="relative max-w-xl ml-4 hidden sm:block">
            <input
              ...
              className="p-2 rounded border border-gray-300 w-64 sm:w-80 md:w-96 pr-10 text-sm sm:text-base focus:outline-none focus:ring-2 focus:ring-teal-500"
            />
            <FontAwesomeIcon
              icon={faSearch}
              className="absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-500 text-sm sm:text-base search-icon"
              title="Search"
            />
          </div>
        </div>
