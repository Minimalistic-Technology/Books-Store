  ...
  const books = [
    {
      ...
      alt: "Algebra Textbook",
      price: "₹89.00",
      description: "English Medium, Maharashtra State Board",
      class: "Class X",
    },
    {
      src: "https://harshbookcenter.com/wp-content/uploads/2025/01/maths-1-algebra-10th-standard-ssc-maharashtra-state-board_6_3c1a2739ef74455990da08f3e1b1d605.png.webp",
    ...
    },
    {
      ...
      alt: "English Kumarhharati Textbook",
      price: "₹79.00",
      description: "English Medium, Latest Edition",
      class: "Class X",
    },
    {
      src: "https://harshbookcenter.com/wp-content/uploads/2025/01/maths-1-algebra-10th-standard-ssc-maharashtra-state-board_6_3c1a2739ef74455990da08f3e1b1d605.png.webp",
      ...
      <main className="flex-grow px-29 py-6">
        <div className="flex">
          ...
          <aside className="w-1/4 pr-6">
            ...
            {/* Filter by Price */}
            <h2 className="text-xl font-semibold mb-4 text-gray-800">Filter by Price</h2>
            <div className="border rounded-lg p-4 bg-white shadow-md mb-6">
            ...
            {/* Product Status */}
            <h2 className="text-xl font-semibold mb-4 text-gray-800">Product Status</h2>
          ...
          <section className="w-3/4 pl-6">
            <h2 className="text-2xl font-semibold mb-4 text-gray-800">School Textbooks</h2>
              ...
              {filteredBooks.map((book, index) => (
                ...
                >
                  ...
                  <div className="p-2 text-center">
                    <p className="text-sm text-black">{book.alt}</p>
                    <p className="text-orange-500 font-bold mt-1">{book.price}</p>
                    <p className="text-gray-600 text-xs mt-1">{book.description}</p>
                    <p className="text-gray-500 text-xs mt-1">Class: {book.class}</p>
                  </div>
                </div>
              ))}
            </div>
